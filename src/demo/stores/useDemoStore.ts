...
import { mockMesas, actualizarEstadoMesaMock, calcularOcupacionTotal, calcularCapacidadUtilizada, calcularIngresosDelDia, calcularRotacionDelDia, obtenerMesasMasRentables, obtenerOcupacionPorHoras, obtenerTiemposPorCapacidad, obtenerMetricasTiempo } from '../data/mockMesas'
...
import { mockAnalytics, exportarDatosMock } from '../data/mockAnalytics'
